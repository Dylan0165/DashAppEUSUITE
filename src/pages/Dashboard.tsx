...
export const Dashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Welcome to EUsuite Dashboard</h2>
        <p className="text-gray-600">Select an application to get started with your workspace</p>
      </div>
